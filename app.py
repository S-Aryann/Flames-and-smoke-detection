...
def predict():
    if request.method == "POST":
        ...
        # Check for Fire or Smoke class
        detected_classes = detections['name'].tolist()
        alert_triggered = any(cls.lower() in ["fire", "smoke"] for cls in detected_classes)

        return render_template("result.html", image_path="static/image0.jpg", alert=alert_triggered)
...
@app.route("/notebook2")
def notebook2():
    return render_template("OtherModelComp.html")
